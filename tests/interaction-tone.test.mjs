...
test("builds a strict interaction classifier request", () => {
  ...
  assert.deepEqual(request.response_format.json_schema.schema.properties.frustrated.items.properties.candidate_id.enum, candidates.map((candidate) => candidate.candidate_id));
});
